...
const RestaurantLayout = ({ tables }) => {
  ...
  const renderChairs = (nbPlaces) => {
    ...
    const positions = chairConfigurations[nbPlaces] || 
  ...
  const renderTable = (table) => (
    <div key={table._id} className="group relative flex justify-center my-12">
      <div className="relative">
        ...
        <div
          className={`w-24 h-24 rounded-full shadow-lg flex flex-col items-center justify-center text-white ${getTableStyle(table.isReserved)} transition duration-300 border-4 border-white relative z-10`}
        >
  ...
  return (
    <div className="p-8">
      <h2 className="text-2xl font-semibold text-center mb-8">Plan du Restaurant</h2>
        ...
        <div className="border-2 border-gray-600 rounded-lg p-6 bg-gray-50 shadow-lg">
          ...
          <div className="text-center mb-6">
            <div className="inline-block px-12 py-3 bg-gray-200 rounded-b-lg border-t-0 border-2 border-gray-300">
              <span className="font-semibold text-gray-700">ENTRÉE PRINCIPALE</span>
            </div>
          </div>
          ...
          <div className="flex justify-between items-start">
            <div className="w-2/5 pl-4">
              ...
              <div className="mt-4 p-4 bg-blue-100 border-2 border-blue-300 rounded-lg text-center shadow-inner">
                <div className="font-semibold text-blue-800">🚻 TOILETTES</div>
            ...
            <div className="w-2/5 pr-4">
              ...
              <div className="mt-4 p-4 bg-amber-100 border-2 border-amber-300 rounded-lg text-center shadow-inner">
                <div className="font-semibold text-amber-800">🛎 ESPACE SERVEUR</div>
          ...
          <div className="mt-4 p-4 bg-red-100 border-2 border-red-300 rounded-lg text-center shadow-inner relative">
            ...
            <div className="flex justify-center space-x-4 mt-2">
              <span className="text-xs bg-white px-2 py-1 rounded">🍳 Grill</span>
              <span className="text-xs bg-white px-2 py-1 rounded">❄️ Frigos</span>
              <span className="text-xs bg-white px-2 py-1 rounded">🍽 Plonge</span>
            </div>
          </div>
        </div>
      </div>
